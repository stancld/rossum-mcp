...
The `fabry` CLI is bundled with the support-fabry package — no separate install needed.

## Usage

Send natural-language prompts to the Rossum Agent via `fabry`.
...
fabry --mcp-mode read-write -x "Add a required string field 'tax_id' to the schema on queue 12345"
