...
class TestPlotData:
    ...
    def test_bar_chart_interactive(self, sample_data, temp_output_dir):
    ...
    def test_bar_chart_static(self, sample_data, temp_output_dir):
    ...
    def test_horizontal_bar_chart(self, sample_data, temp_output_dir):
    ...
    def test_pie_chart_interactive(self, sample_data, temp_output_dir):
    ...
    def test_pie_chart_static(self, sample_data, temp_output_dir):
    ...
    def test_line_chart_single_series(self, temp_output_dir):
    ...
    def test_line_chart_multi_series(self, temp_output_dir):
    ...
    def test_scatter_plot(self, temp_output_dir):
    ...
    def test_heatmap(self, temp_output_dir):
    ...
    def test_sorting_descending(self, sample_data, temp_output_dir):
    ...
    def test_sorting_ascending(self, sample_data, temp_output_dir):
    ...
    def test_no_value_labels(self, sample_data, temp_output_dir):
    ...
    def test_custom_dimensions(self, sample_data, temp_output_dir):
    ...
    def test_color_schemes(self, sample_data, temp_output_dir):
    ...
    def test_invalid_chart_type(self, sample_data, temp_output_dir):
    ...
    def test_auto_extension_html(self, sample_data, temp_output_dir):
    ...
    def test_auto_extension_png(self, sample_data, temp_output_dir):
    ...
    def test_directory_creation(self, sample_data, tmp_path):
