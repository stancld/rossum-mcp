...
SORTING_WARMUP_PROMPT = """1. Create three new queues in namespace `1777693` - Air Waybills, Certificates of Origin, Invoices.
...
7. Set up the engine is trained from thr three created queues - Air Waybills, Certificates of Origin, Invoices.
    - DO NOT copy queue knowledge
    - DO configure queue engine via MCP
