...
- Annotation responses from `get_annotation` now include resolved `workspaces` URLs — workspace association is derived from the linked queue [#333](https://github.com/stancld/rossum-agents/pull/333)
