...
- Decompose monolithic `create/handler.py` into per-domain register functions (`annotations`, `email_templates`, `engines`, `hooks`, `queues`, `rules`, `users`, `workspaces`) [#350](https://github.com/stancld/rossum-agents/pull/350)
