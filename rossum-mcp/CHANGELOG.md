...
- Added `get_document_relation` and `list_document_relations` methods for `rossum_api.models.document)relation.DcoumentRelation` objects. [#51](https://github.com/stancld/rossum-mcp/pull/51)
