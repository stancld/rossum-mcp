...
def suggest_lookup_field(
    ...
    try:
        ...
        return _handle_api_error(e, "suggest_lookup_field")
...
def evaluate_lookup_field(
    ...
    try:
        ...
        return _handle_api_error(e, "evaluate_lookup_field")
...
def get_lookup_dataset_raw_values(dataset: str, limit: int = 10000) -> str:
    ...
    try:
        ...
        return _handle_api_error(e, "get_lookup_dataset_raw_values")
