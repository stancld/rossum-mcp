...
# Result contains:
# - result.created: List of (ObjectType, source_id, target_id, name)
# - result.failed: List of (ObjectType, source_id, name, error)
# - result.skipped: List of (ObjectType, source_id, name, reason)
# - result.id_mapping: IdMapping object with source→target ID mappings
```
