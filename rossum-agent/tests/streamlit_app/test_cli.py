...
class TestCli:
    ...
    def test_main_calls_streamlit_run(self, mock_call: MagicMock):
    ...
    @patch("rossum_agent.streamlit_app.cli.subprocess.call")
    def test_main_passes_extra_args(self, mock_call: MagicMock):
    ...
    @patch("rossum_agent.streamlit_app.cli.subprocess.call")
    def test_main_returns_subprocess_exit_code(self, mock_call: MagicMock):
    ...
    @patch("rossum_agent.streamlit_app.cli.subprocess.call")
    def test_main_uses_correct_app_path(self, mock_call: MagicMock):
    ...
    @patch("rossum_agent.streamlit_app.cli.subprocess.call")
    def test_main_with_no_extra_args(self, mock_call: MagicMock):
