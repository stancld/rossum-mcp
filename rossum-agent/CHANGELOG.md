...
### Added
- Added dynamic tool loading to reduce initial context usage (~8K → ~800 tokens) [#113](https://github.com/stancld/rossum-mcp/pull/113)
- Added `load_tool_category(["queues", "schemas"])` internal tool to load MCP tools on-demand [#113](https://github.com/stancld/rossum-mcp/pull/113)
- Added automatic pre-loading of tool categories based on keywords in user's first message [#113](https://github.com/stancld/rossum-mcp/pull/113)
...
### Added
- Added `search_knowledge_base` internal tool for searching Rossum Knowledge Base documentation with Opus-powered analysis [#72](https://github.com/stancld/rossum-mcp/pull/72)
- Added `evaluate_python_hook` internal tool for sandboxed hook execution against test annotation/schema data [#72](https://github.com/stancld/rossum-mcp/pull/72)
- Added `debug_hook` internal tool using Opus sub-agent for iterative hook debugging with root cause analysis and fix suggestions [#72](https://github.com/stancld/rossum-mcp/pull/72)
- Added `web_search` and `read_web_page` internal tools for web search capabilities [#72](https://github.com/stancld/rossum-mcp/pull/72)
- Added multi-turn conversation guidelines to prompts [#72](https://github.com/stancld/rossum-mcp/pull/72)

### Changed
- Improved tool result serialization in agent core to handle pydantic models and dataclasses properly [#72](https://github.com/stancld/rossum-mcp/pull/72)
- Kept image in the context for the whole conversation [#72](https://github.com/stancld/rossum-mcp/pull/72)
- Enabled short, concise answers by default [#72](https://github.com/stancld/rossum-mcp/pull/72)
- Improved `list_hook` and `get_hook` MCP tool descriptions [#72](https://github.com/stancld/rossum-mcp/pull/72)

### Fixed
- Fixed sending generated files to front-end in API responses [#72](https://github.com/stancld/rossum-mcp/pull/72)
