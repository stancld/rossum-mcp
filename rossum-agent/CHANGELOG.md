...
- `generate_mock_pdf`: Unicode font support — auto-detects system TTF fonts (DejaVu Sans, Arial) so PDF text renders diacritics (e.g. Czech "Č", "ě") correctly; falls back to Helvetica with diacritic stripping on systems without TTF fonts [#319](https://github.com/stancld/rossum-agents/pull/319)
...
### Fixed
- Sanitize mermaid diagram syntax in agent responses — prevents malformed `mermaid` code blocks from breaking rendering [#307](https://github.com/stancld/rossum-agents/pull/307)
